			...
			<div class="col-md-12" >
				<div class="tabbable servicetab tabs-left">
					<ul class="nav nav-tabs" style="width: 100%">
						<li><a href="services#myTourPlan" class="active" data-toggle="tab" style="33%">강사 리스트</a></li>
				...
				<div class="col-md-12">
					<div class="col-md-3">
                     <div class="standImg" style="height: 100%">
                        <img class=imghotel src="resources/img/login/img/무주펜션2.jpg"
                           alt="스탠다드온돌(SOD) 전경 이미지" style="height: 100%; width: 100%">
                     </div>
                     </div>
                     <div class="col-md-9">
